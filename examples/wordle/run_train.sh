#!/usr/bin/env bash
# Launch FSDP2 training for the Wordle demo on GPU 2,3.
#
# Prerequisite: sglang server already running (see serve.sh).
#
# Usage:
#   bash examples/wordle/run_train.sh           # GPU 2,3
#   bash examples/wordle/run_train.sh 2,3       # explicit
...
RUN_DIR="${RUN_DIR:-$REPO_DIR/runs/wordle_demo}"
