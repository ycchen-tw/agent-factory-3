#!/usr/bin/env bash
# Launch sglang TP=2 server for the Wordle demo.
#
...
#
# Usage:
#   bash examples/wordle/serve.sh                # GPU 0,1, port 30100
#   bash examples/wordle/serve.sh 0,1 30100      # explicit GPUs and port
