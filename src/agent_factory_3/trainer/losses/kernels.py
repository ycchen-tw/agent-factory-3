# source: https://github.com/volcengine/verl/blob/main/verl/utils/kernel/kernels.py
#
...
def efficient_entropy_forward(
    ...
    assert hidden_size % 32 == 0, f"hidden_size must be divisible by BLOCK_SIZE_K (32), got {hidden_size}"
